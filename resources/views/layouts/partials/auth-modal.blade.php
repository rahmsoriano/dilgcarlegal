...
<style>
    ...
    .exact-auth-modal .exact-auth-privacy {
        display: flex;
        align-items: center;
        gap: 18px;
        margin-top: 14px;
    ...
    .exact-auth-modal .exact-auth-privacy-badge {
        width: 52px;
        height: 52px;
        flex: 0 0 auto;
        display: grid;
    ...
    .exact-auth-modal .exact-auth-privacy-text {
        margin: 0;
        font-size: 11px;
        line-height: 1.45;
        color: #51607f;
...
<div id="auth-login-modal" class="auth-modal exact-auth-modal hidden fixed inset-0 z-[2147483100]" aria-hidden="true">
                        ...
                        <div data-auth-views-root data-initial-mode="login" class="relative">
                            ...
                            <div class="auth-view absolute inset-0" data-view="register" aria-hidden="true">
                                ...
                                <form method="POST" action="{{ route('register') }}" class="exact-auth-form">
                                    ...
                                    <div class="exact-auth-grid">
                                        ...
                                        <div class="exact-auth-field">
                                            ...
                                            <div class="exact-auth-control">
                                                ...
                                                <span class="exact-auth-trailing" aria-hidden="true">
                                        ...
                                        <div class="exact-auth-field">
                                            ...
                                            <div class="exact-auth-control">
                                                ...
                                                <input id="modal_register_password" name="password" type="password" required autocomplete="new-password" placeholder="Password">
                                    ...
                                    <div class="exact-auth-privacy">
                                        <div class="exact-auth-privacy-badge" aria-hidden="true">
                                        ...
                                        <p class="exact-auth-privacy-text">We respect your privacy. Your information is secure and will only be used to enhance your legal research experience.</p>
                                    </div>
